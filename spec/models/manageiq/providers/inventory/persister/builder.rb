require "manageiq/providers/inventory/persister/builder/cloud_manager"
require "manageiq/providers/inventory/persister/builder/shared"
    ...
    class Persister
      class Builder
        ...
        def auto_inventory_attributes
          ...
          (@properties[:model_class].new.methods - ActiveRecord::Base.methods).grep(/^[\w]+?\=$/).collect do |setter|
