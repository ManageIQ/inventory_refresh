module SpecMockedData
  def initialize_mocked_records
    @flavor1 = FactoryBot.create(:flavor_cloud, flavor_data(1).merge(:ext_management_system => @ems))
    @flavor2 = FactoryBot.create(:flavor_cloud, flavor_data(2).merge(:ext_management_system => @ems))
    @flavor3 = FactoryBot.create(:flavor_cloud, flavor_data(3).merge(:ext_management_system => @ems))
