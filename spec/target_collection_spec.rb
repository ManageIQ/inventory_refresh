describe InventoryRefresh::TargetCollection do
  ...
  context ".add_target" do
    it "intializes correct InventoryRefresh::Target object" do
      target_collection = InventoryRefresh::TargetCollection.new(:manager => @ems)
    ...
    it "intializes correct InventoryRefresh::Target object with manager_id" do
      target_collection = InventoryRefresh::TargetCollection.new(:manager_id => @ems.id, :event => @ems_event)
    ...
    it "intializes correct InventoryRefresh::Target object with event" do
      target_collection = InventoryRefresh::TargetCollection.new(:manager => @ems, :event => @ems_event)
